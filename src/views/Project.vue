<template>
  <v-card id="project">
    <v-card-text>
      ...
      <h3 class="text-xs-center">{{subtitle}}</h3>
    ...
    <v-container fluid grid-list-md>
      ...
      <v-img :src="imageLink" aspect-ratio=""  height="300" contain></v-img>
      </v-flex>
    </v-layout>
    </v-container>
                ...
                <v-card color="blue-grey lighten-3" dark>
                    ...
                    <v-layout align-center>
                        <v-flex xs12 sm4 text-xs-center>
                            <div>
                                <a v-if="githubLink" :href="githubLink" target="_blank"><v-btn round color="blue lighten-1">Github Link</v-btn></a>
                                <a v-if="projectLink" :href="projectLink" target="_blank"><v-btn round color="blue lighten-1">View Project</v-btn></a>
...
export default {
  ...
  mounted () {
    if (this.data) {
      ...
      this.githubLink = this.data.githubLink
    }
  }
}
</script>
